...
class InterfaceController: WKInterfaceController {
    ...
    @IBOutlet var drawCardButton: WKInterfaceButton!
    ...
    @IBAction func clearButtonPressed() {
        ...
        tarotCardImage.setImage(#imageLiteral(resourceName: "Back"))
        
        drawCardButton.setHidden(false)
